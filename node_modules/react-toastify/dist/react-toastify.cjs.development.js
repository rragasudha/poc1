...
function cssTransition(_ref) {
  ...
  return function (_ref2) {
    ...
    return React__default.createElement(reactTransitionGroup.Transition, Object.assign({}, props, {
...
var Toast = function Toast(props) {
  ...
  return React__default.createElement(Transition, {
    ...
    style: style,
    ref: toastRef
  }), React__default.createElement("div", Object.assign({}, props["in"] && {
    role: role
  }, {
    className: cx(RT_NAMESPACE + "__toast-body", bodyClassName),
    style: bodyStyle
  }), children), renderCloseButton(closeButton), (autoClose || controlledProgress) && React__default.createElement(ProgressBar, Object.assign({}, updateId && !controlledProgress ? {
    key: "pb-" + updateId
  } : {}, {
    rtl: rtl,
    delay: autoClose,
...
function dispatchToast(content, options) {
  if (isAnyContainerMounted()) {
    ...
    if (lazy && canUseDom) {
      ...
      reactDom.render(React__default.createElement(ToastContainer, Object.assign({}, containerConfig)), containerDomNode);
    }
  }
